      ...
      <ul className="event-list">
        ...
        <li>
          ...
          <div className="info">
            ...
            <ul>
              <li style={{ width: "50%" }}>
                <a href="#website">
                  <span className="fa fa-globe" /> Website
                </a>
              </li>
              <li style={{ width: "50%" }}>
        ...
        <li>
          ...
          <div className="info">
            ...
            <ul>
              <li style={{ width: "33%" }}>
                1 <span className="glyphicon glyphicon-ok" />
              </li>
              <li style={{ width: "34%" }}>
                3 <span className="fa fa-question" />
              </li>
              <li style={{ width: "33%" }}>
                103 <span className="fa fa-envelope" />
              </li>
            </ul>
          </div>
          <div className="social">
        ...
        <li>
          ...
          <img
            alt="Disney Junior Live On Tour!"
          ...
          <div className="info">
            ...
            <ul>
              <li style={{ width: "33%" }}>
                $49.99 <span className="fa fa-male" />
              </li>
              <li style={{ width: "34%" }}>
                $29.99 <span className="fa fa-child" />
              </li>
            </ul>
          </div>
          <div className="social">
