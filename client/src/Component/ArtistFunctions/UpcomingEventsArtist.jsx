...
const UpcomingEventsArtist = () => {
  ...
  <div className="input-group rounded">
    ...
    <span className="input-group-text border-0" id="search-addon">
      <i className="custom-search-icon fas fa-search" style={{ fontSize: '12px' }} />
    </span>
  </div>
</div>
  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-12">
        ...
        <Button style={{width:"16rem",marginTop:"2px"}} href="reserve">Reserve</Button>
        ...
        <Button style={{width:"16rem",marginTop:"-11px"}}>Reserve</Button>
        ...
        <Button style={{width:"16rem",marginTop:"2px"}}>Reserve</Button>
