...
const Mothersday = () => {
  return (
    ...
    <p>Please share the informations of your big day so we can help you along your mother'sday wishes more special!!</p>
    <hr></hr>
    <div style={{ display: 'block', 
          ...
          <Form>
          <Form.Group>
      <Form.Label>Enter your greetings here:</Form.Label>
      <Form.Control as="textarea" placeholder="Type your greetings here.." />
    </Form.Group>
          {/* <Form.Group>
      ...
      <Form.Control as="file" placeholder="Enter your ideas here.." />
       ...
       <div className='bottom'>
        ...
        -A preview of your design will be emailed to you within 1 working day.<br/>
          ...
          <hr></hr>
        <p style={{textAlign:"center",fontSize:"2rem"}}>Top customized Mothers'day Gifts..</p>
        <hr></hr>
        {/* <table>
