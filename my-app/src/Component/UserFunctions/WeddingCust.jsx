...
<p>Please share the informations of your big day so we can help you along your wedding day make special!!</p>
<hr></hr>
<div style={{ display: 'block', 
      ...
      <Form>
      <Form.Group>
          <Form.Label>Enter your Husband name:</Form.Label>
          <Form.Control type="text" 
                        placeholder="Husband Name" />
        </Form.Group>
      <Form.Group>
          <Form.Label>Enter your Wife name:</Form.Label>
          <Form.Control type="text" 
        ...
        <Form.Group>
          <Form.Label>Enter Wedding Date</Form.Label>
  ...
  <Form.Control as="file" placeholder="Enter your ideas here.." />
   ...
   <div className='bottom'>
    ...
    -A preview of your design will be emailed to you within 1 working day.<br/>
      ...
      <hr></hr>
    <p style={{textAlign:"center",fontSize:"2rem"}}>You may be like</p>
    <hr></hr>
    {/* <table>
